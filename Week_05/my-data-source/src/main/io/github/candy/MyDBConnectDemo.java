...
public class MyDBConnectDemo {
    ...
    private void createConnection() {
        ...
        try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost:33065/sms_v2", "root", "root");
            if (connection != null) {
    ...
    public static void main(String[] args) {
        ...
        try {
            MyDBConnectDemo mysqlJdbc = new MyDBConnectDemo();
