package io.github.candy.gateway.server;

import io.github.candy.gateway.handler.HttpHandlerInitializer;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
                    .handler(new LoggingHandler(LogLevel.INFO)).childHandler(new HttpHandlerInitializer(this.proxyServer));
